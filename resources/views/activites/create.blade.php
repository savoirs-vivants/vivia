                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-400">Créneaux sur une période définie</p>
                                        </div>
                                    </div>
                                </div>
                            </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" min="1" name="max_eleves"
                                value="{{ old('max_eleves') }}" placeholder="Ex: 12"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm text-gray-700 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#16987C]/30 focus:border-[#16987C]/40 transition-all">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="date_debut_club_maker"
                                        value="{{ old('date_debut_club_maker') }}"
                        ...
                        <div x-show="typeActivite === 'activite' || typeActivite === 'club_maker'" x-cloak x-data="{ sansHoraires: false }"
