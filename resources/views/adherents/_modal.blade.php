                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex gap-2">
                            <div class="flex-1">
                                ...
                                <div class="relative">
                                    <input type="number" x-model="montantVersement" @input="calculerResteApresVersement()"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-3 pt-2 border-t border-gray-50 flex justify-end"
                            ...
                            <p class="text-xs text-gray-400">+ Adhésion annuelle : <span class="font-semibold" x-text="adherent.montantAdhesion || '10,00 €'"></span></p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="p-3 bg-gray-50 rounded-xl border border-gray-100 space-y-3"
                            ...
                            <div x-show="plusieursVersements"
                                ...
                                <p class="text-xs text-gray-400">
                                    Le statut passera en <span class="font-bold text-amber-600">Partiel</span> jusqu'au solde complet.
                                </p>
                            </div>
                        </div>
