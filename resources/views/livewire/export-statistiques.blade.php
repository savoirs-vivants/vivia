<div x-data="{ open: false }" class="relative z-50">
    ...
    <button @click="open = !open" @click.outside="open = false"
        class="flex items-center gap-2 bg-[#222A60] hover:bg-[#1a2050] transition-colors text-white font-bold text-sm px-5 py-2.5 rounded-full shadow-sm">
    ...
    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
        ...
        class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 z-50 overflow-hidden origin-top-right">
        ...
        <div class="py-1 p-1">
            <button wire:click="exportExcel" @click="open = false"
                ...
                <span class="font-bold">Format Excel</span>
            </button>
            ...
            <button wire:click="exportCsv" @click="open = false"
                ...
                <span class="font-bold">Format CSV</span>
            </button>
        </div>
    </div>
</div>
