...
@section('content')
    ...
    <div class="max-w-sm mx-auto py-12 px-4 text-center">
        ...
        <form action="{{ route('adhesion.modifier.verifier.submit', $token) }}" method="POST" class="mb-4">
            ...
            <input type="text" name="code" maxlength="6" inputmode="numeric" autocomplete="one-time-code" required
                placeholder="000000"
                class="w-full text-center tracking-[0.5em] text-2xl font-mono px-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500/25 focus:border-teal-500 mb-4">
            <button type="submit"
