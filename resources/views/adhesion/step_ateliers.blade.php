                                                                ...
                                                                <div class="flex-1 min-w-0">
                                                                    ...
                                                                    @if ($item->condition_location)
                                                                        <div class="mt-2 flex items-start gap-1.5">
                                                                            <span
                                                                                class="text-xs shrink-0 mt-0.5">📋</span>
                                                                            <p
                            ...
                            @if ($typeActivite !== 'ressourcerie')
                                    ...
                                    <div x-data="{ openVilles: [] }" class="space-y-3 mb-6">
                                        @foreach ($ateliersParVille as $ville => $villeActivites)
                                            @php
                                                ...
                                                $hasSelected = $villeActivites->contains(
                                                    fn($a) => in_array($a->id, $selectedActivites),
                                                );
                                            @endphp
                                            <div
                                            ...
                                            {{ $hasSelected ? 'border-teal-400' : 'border-gray-200' }}">
                                                ...
                                                <button type="button"
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <span
                                                            class="font-bold text-slate-900 text-base">{{ $ville }}</span>
                                                        <span
                                                    ...
                                                    @foreach ($villeActivites as $activite)
                                                        ...
                                                        <div x-data="{ checked: {{ in_array($activite->id, $selectedActivites) ? 'true' : 'false' }} }">
                                                            <input type="checkbox" name="activites_selectionnees[]"
                                                                value="{{ $activite->id }}" x-model="checked"
                                                                class="hidden">
                                                            <div @click="checked = !checked"
                                                                :class="checked
                                                                    ?
                                                                ...
                                                                <div class="flex-1 min-w-0">
                                                                    ...
                                                                    @if ($firstJour && $firstHeure)
                                                                        <p
                                                                            class="text-xs text-gray-500 font-medium mt-1.5 flex items-center gap-1.5">
                                                                    ...
                                                                    @if ($activite->tarif !== null)
                                                                        <p
                                                                            class="text-xs font-black text-teal-600 mt-1">
                                ...
                                @elseif ($typeActivite === 'club_maker')
                                    <div x-data="{
                                        ...
                                        <div
                                            class="flex items-center gap-2 mb-3 px-1 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                                        ...
                                        @foreach ($clubMakerActivites as $activite)
                                            ...
                                            <template x-if="isSelected({{ $activite->id }})">
                                                <input type="hidden" name="activites_selectionnees[]"
                                                    value="{{ $activite->id }}">
                                            </template>
                                            <div @click="toggle({{ $activite->id }})"
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    @if ($activite->adresse)
                                                        <p
                                                            class="text-xs text-gray-500 font-medium mt-1.5 flex items-start gap-1">
                                                ...
                                                <div class="w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors mt-0.5"
                                                    :class="isSelected({{ $activite->id }}) ? 'border-teal-600 bg-teal-600' :
                                                        'border-gray-300'">
                                                    <svg x-show="isSelected({{ $activite->id }})"
