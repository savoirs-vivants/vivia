...
<body style="font-family: 'Space Grotesk', Arial, sans-serif; background-color: #f3f4f6; margin: 0; padding: 40px 20px; color: #4b5563;">
    ...
    <div style="max-width: 520px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 40px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); border: 1px solid #e5e7eb;">
        ...
        <p style="font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
            Nous avons le plaisir de vous confirmer que l'adhésion pour <strong style="color: #222A60;">{{ $adherent->prenom }} {{ $adherent->nom }}</strong> a bien été validée et finalisée ! 🎉
        </p>
        ...
        <div style="text-align: center; background-color: #f8fafc; border: 2px dashed #e2e8f0; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
            <span style="display: block; font-size: 12px; text-transform: uppercase; color: #94a3b8; font-weight: 700; margin-bottom: 4px; letter-spacing: 1px;">Le numéro d'adhérent</span>
            <span style="font-family: 'Space Mono', monospace; font-size: 28px; color: #16987C; font-weight: 700;">{{ $adherent->numero_adherent ?? $adherent->id }}</span>
        </div>

        <p style="font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
            Merci pour votre confiance. Nous avons hâte de vous retrouver pour cette nouvelle saison !
        </p>
        ...
        <p style="color: #9ca3af; font-size: 13px; line-height: 1.5; text-align: center; margin: 0;">
            Cet email est généré automatiquement suite à la validation de votre paiement.
        </p>
